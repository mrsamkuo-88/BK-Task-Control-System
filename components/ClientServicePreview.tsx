...
import { ArrowLeft, Check, Sparkles, Mail, Phone, ExternalLink } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
      ...
      <header className="bg-white border-b border-slate-100 py-4 px-6 sticky top-0 z-50 flex items-center justify-between">
          <div className="flex items-center gap-2">
              ...
              <h1 className="font-bold text-lg text-slate-800 tracking-tight">街趣 <span className="text-indigo-600">Street Fun</span></h1>
          </div>
      ...
      <div className="max-w-4xl mx-auto p-6 md:p-12">
                  ...
                  <div className="flex flex-col md:flex-row gap-8 items-start justify-between">
                      ...
                      <div className="w-full md:w-80 bg-slate-900 text-white p-6 rounded-2xl shadow-xl shadow-slate-900/10">
                          ...
                          <div className="space-y-3">
                              <button className="w-full py-3 bg-indigo-600 hover:bg-indigo-500 rounded-xl font-bold transition-colors text-sm flex items-center justify-center gap-2">
                                  <Phone size={16}/> 聯繫顧問
                              </button>
                              <div className="text-center text-xs text-slate-500">或是 Email 至 service@streetfun.com</div>
                          </div>
                      </div>
                  </div>
              </div>
          ...
          <div className="mt-8 text-center text-slate-400 text-xs font-medium">
              Powered by Street Fun Ops Control • {new Date().getFullYear()}
          </div>
      </div>
    </div>
  );
