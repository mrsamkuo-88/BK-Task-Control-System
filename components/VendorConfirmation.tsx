                ...
                <div className="flex justify-between items-center mb-6">
                    ...
                    {isEditable && (
                        <button 
                            ...
                            className="text-xs bg-amber-50 text-amber-600 px-2 py-1 rounded font-bold hover:bg-amber-100 flex items-center gap-1"
                        >
                            <Plus size={12}/> 新增
                        </button>
                    )}
                      ...
                      <div className="space-y-3">
                          {task.requiredActions.map((action, idx) => (
                              <label key={idx} className="flex items-start gap-3 p-3 rounded-xl border border-slate-100 hover:bg-slate-50 cursor-pointer transition-colors">
                                  <div className={`mt-0.5 w-5 h-5 rounded-md border flex items-center justify-center shrink-0 transition-colors ${isSubmitted ? 'bg-slate-100 border-slate-300 text-slate-400' : 'border-indigo-200 text-white bg-white checked:bg-indigo-600'}`}>
